...
/-
Partial references:
Allen Hatcher, Algebraic Topology. Chapter 0, Operations on Spaces (from page 8, ignoring cell complexes)
...
def MapSuspension : Suspension X → Suspension X' := by {
  ...
  intro a b hab
  simp[cyl_setoid, MapTimesI]
  sorry
}


-- (free) suspension is a functor
--[TODO]
